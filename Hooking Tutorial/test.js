...
setTimeout(function() {
    Java.perform(function() {
        ...
        var c_MainActivity_hook = Java.use("uk.rossmarks.fridalab.MainActivity");
        ...
        var overloadz_MainActivity_hook = eval("c_MainActivity_hook.chall03.overloads");
        var ovl_count_MainActivity_hook = overloadz_MainActivity_hook.length;
        ...
        var c_MainActivity_hook_chall03_hook = eval('c_MainActivity_hook.chall03.overloads[0]')

        c_MainActivity_hook_chall03_hook.implementation = function() {
            var sendback = ''
            var args = arguments
            retval = null
            var eval_result = null
            var eval_packet = null
            // retval = eval('this.chall03.apply(this, arguments)')
            try {
                retval = eval('this.chall03.apply(this, arguments)')
            ...
            while (true){
                ...
                if(recv_option == "terminate"){
                    ...
                    if (recv_time == timestamp){
                        ...
                        retval = eval('this.chall03.apply(this, args)')
